  ...
  const clientHtml = `
    <div style="font-family: Inter, sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0f; color: #ffffff; border-radius: 16px; overflow: hidden;">
      ...
      <div style="padding: 32px; text-align: center;">
        ...
        <a href="http://localhost:3000" style="display: inline-block; padding: 12px 28px; background: linear-gradient(135deg, #7c3aed, #6d28d9); color: white; border-radius: 12px; text-decoration: none; font-weight: 600;">
          Visit Our Website
        </a>
      </div>
    </div>
